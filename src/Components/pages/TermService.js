...
import { getTermsConditions } from './core/_request';
    ...
    return (<> 
...

        {
            isloading ?
                ...
                <section className="jurny_sectoion mb-5 text-start h-100">
                    ...
                    <Container className='text-common my-4'>
                        {
                            termsservice ?
                                <div className='mb-4 terms_set' dangerouslySetInnerHTML={{ __html: termsservice ?? '' }} />
                                :
